            ...
            <div class="card-body">
              ...
              <p class="card-description float-right">
                <b-button variant="success" v-b-modal.modalTatib v-on:click="Add">
                  <i class="mdi mdi-plus btn-icon-prepend"></i> Tambah</b-button>
              </p>
...
module.exports = {
  ...
  methods: {
    ...
    Add : function(){
      this.action = "insert"
      this.id = ""
      this.id_petugas = this.$store.getters.userDetail.id //id dari isi userDetail
      this.id_siswa = ""
      this.id_pelanggaran = ""
      this.keterangan = ""
      this.tanggal = ""
